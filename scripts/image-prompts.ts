...
export const PROMPTS: ImagePrompt[] = [
  ...
  { cardId: 'auth-shame-genuine', prompt: `${STYLE_BASE} A 28-year-old woman in genuine shame. Head bowed, gaze averted DOWN AND TO THE SIDE, hand near the lower face partially covering chin or mouth. CRITICAL: visible blush across cheeks and possibly the tops of ears — vegetative redness signaling involuntary autonomic response. Posture compressed inward, shoulders rolled forward. The body language of wanting to disappear.` },
